...
<link rel="alternate" hreflang="en" href="https://lilianweng.github.io/posts/2021-07-11-diffusion-models/" />
<noscript>
    <style>
        #theme-toggle,
        .top-link {
...
<article class="post-single">
  <header class="post-header">
    ...
    <div class="post-meta">Date: July 11, 2021  |  Estimated Reading Time: 31 min  |  Author: Lilian Weng
...
<span class="update">[Updated on 2024-04-13: Added <a href="#prog-distll">progressive distillation</a>, <a href="#consistency">consistency models</a>, and the <a href="#model-architecture">Model Architecture section</a>.</span></p>
...
<figure>
	<img src="generative-overview.png" style="width: 100%;"  />
	<figcaption>Overview of different types of generative models.</figcaption>
</figure>
...
<figure>
	<img src="DDPM.png" style="width: 100%;"  />
	<figcaption>The Markov chain of forward (reverse) diffusion process of generating a sample by slowly adding (removing) noise. (Image source: <a href="https://arxiv.org/abs/2006.11239" target="_blank">Ho et al. 2020</a> with a few additional annotations)</figcaption>
</figure>
...
<figure>
	<img src="diffusion-example.png" style="width: 100%;"  />
	<figcaption>An example of training a diffusion model for modeling a 2D swiss roll data. (Image source: <a href="https://arxiv.org/abs/1503.03585" target="_blank">Sohl-Dickstein et al., 2015</a>)</figcaption>
</figure>
...
<figure>
	<img src="DDPM-algo.png" style="width: 100%;"  />
...
<figure>
	<img src="diffusion-beta.png" style="width: 65%;"  />
	<figcaption>Comparison of linear and cosine-based scheduling of $\beta\_t$ during training. (Image source: <a href="https://arxiv.org/abs/2102.09672" target="_blank">Nichol & Dhariwal, 2021</a>)</figcaption>
</figure>
...
<figure>
	<img src="improved-DDPM-nll.png" style="width: 70%;"  />
	<figcaption>Comparison of negative log-likelihood of improved DDPM with other likelihood-based generative models. NLL is reported in the unit of bits/dim. (Image source: <a href="https://arxiv.org/abs/2102.09672" target="_blank">Nichol & Dhariwal, 2021</a>)</figcaption>
</figure>
...
<figure>
	<img src="conditioned-DDPM.png" style="width: 100%;"  />
	<figcaption>The algorithms use guidance from a classifier to run conditioned generation with DDPM and DDIM. (Image source:  <a href="https://arxiv.org/abs/2105.05233" target="_blank">Dhariwal & Nichol, 2021</a>])</figcaption>
</figure>
...
<figure>
	<img src="DDIM-results.png" style="width: 100%;"  />
	<figcaption>FID scores on CIFAR10 and CelebA datasets by diffusion models of different settings, including $\color{cyan}{\text{DDIM}}$ ($\eta=0$) and $\color{orange}{\text{DDPM}}$ ($\hat{\sigma}$). (Image source: <a href="https://arxiv.org/abs/2010.02502" target="_blank">Song et al., 2020</a>)</figcaption>
</figure>
...
<figure>
	<img src="progressive-distillation.png" style="width: 100%;"  />
	<figcaption>Progressive distillation can reduce the diffusion sampling steps by half in each iteration. (Image source: <a href="https://arxiv.org/abs/2202.00512" target="_blank">Salimans & Ho, 2022</a>)</figcaption>
</figure>
...
<figure>
	<img src="progressive-distillation-algo.png" style="width: 100%;"  />
	<figcaption>Comparison of Algorithm 1 (diffusion model training) and Algorithm 2 (progressive distillation) side-by-side, where the relative changes in progressive distillation are highlighted in green.<br/>(Image source: <a href="https://arxiv.org/abs/2202.00512" target="_blank">Salimans & Ho, 2022</a>)</figcaption>
</figure>
...
<figure>
	<img src="consistency-models.png" style="width: 75%;"  />
	<figcaption>Consistency models learn to map any data point on the trajectory back to its origin. (Image source: <a href="https://arxiv.org/abs/2303.01469" target="_blank">Song et al., 2023</a>)</figcaption>
</figure>
...
<li>$d(.,.)$ is a positive distance metric function that satisfies $\forall \mathbf{x}, \mathbf{y}: d(\mathbf{x}, \mathbf{y}) \geq 0$ and $d(\mathbf{x}, \mathbf{y}) = 0$ if and only if $\mathbf{x} = \mathbf{y}$ such as $\ell_2$, $\ell_1$ or <a href="https://arxiv.org/abs/1801.03924">LPIPS</a> (learned perceptual image patch similarity) distance;</li>
...
<figure>
	<img src="consistency-models-exp.png" style="width: 100%;"  />
	<figcaption>Comparison of consistency models' performance under different configurations. The best configuration for CD is LPIPS distance metric, Heun ODE solver, and $N=18$.  (Image source: <a href="https://arxiv.org/abs/2303.01469" target="_blank">Song et al., 2023</a>)</figcaption>
</figure>
...
<figure>
	<img src="image-distortion-rate.png" style="width: 50%;"  />
	<figcaption>The plot for tradeoff between compression rate and distortion, illustrating two-stage compressions - perceptual and semantic compression. (Image source: <a href="https://arxiv.org/abs/2112.10752" target="_blank">Rombach & Blattmann, et al. 2022</a>)</figcaption>
</figure>
...
<figure>
	<img src="latent-diffusion-arch.png" style="width: 80%;"  />
	<figcaption>The architecture of the latent diffusion model (LDM). (Image source: <a href="https://arxiv.org/abs/2112.10752" target="_blank">Rombach & Blattmann, et al. 2022</a>)</figcaption>
</figure>
...
<figure>
	<img src="cascaded-diffusion.png" style="width: 100%;"  />
	<figcaption>A cascaded pipeline of multiple diffusion models at increasing resolutions. (Image source:  <a href="https://arxiv.org/abs/2106.15282" target="_blank">Ho et al. 2021</a>])</figcaption>
</figure>
...
<figure>
	<img src="unCLIP.png" style="width: 100%;"  />
	<figcaption>The architecture of unCLIP. (Image source:  <a href="https://arxiv.org/abs/2204.06125" target="_blank">Ramesh et al. 2022</a>])</figcaption>
</figure>
...
<figure>
	<img src="U-net.png" style="width: 100%;"  />
...
<figure>
	<img src="ControlNet.png" style="width: 70%;"  />
	<figcaption>The ControlNet architecture. (Image source: <a href="https://arxiv.org/abs/2302.05543" target="_blank">Zhang et al. 2023</a>)</figcaption>
</figure>
...
<figure>
	<img src="DiT.png" style="width: 75%;"  />
	<figcaption>The Diffusion Transformer (DiT) architecture.<br/>(Image source: <a href="https://arxiv.org/abs/2212.09748" target="_blank">Peebles & Xie, 2023</a>)</figcaption>
</figure>
